...
const AddAppointment = (observer(() => {
    ...
    //לפרטי ההזמנה
    const [appointment, setAppointment] = useState({ service: "", date: "", name: "", email: "", phone: "" });
    ...
    const handleSubmit = async () => {
        ...
        if (appointment.service != ""  && appointment.date != "" && appointment.name != "" && appointment.email != "" && appointment.phone != "") {
          await addAppointment(appointment);
            if (dataStore.isAppointment === true) {
                setAppointment({ service: "",  date: "", name: "", email: "", phone: "" });
                console.log("success");
                setOpen(false);
                Swal.fire({
                    position: "center",
    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <DialogTitle>להשכרה </DialogTitle>
                <DialogContent>
